...
void game(SDL_Window *screen,uint *state,uint *grapset,uint *fullscreen)
{
	...
	/* Loading PNG */
	tiles = SDL_CreateTexture(renderer,SDL_PIXELFORMAT_ARGB8888,SDL_TEXTUREACCESS_STATIC,1000,240);
	tilesb = IMG_Load("/usr/share/abbayev2/graphics/tiles.png");
	...
	fonts = IMG_LoadTexture(renderer,"/usr/share/abbayev2/graphics/fonts.png");
